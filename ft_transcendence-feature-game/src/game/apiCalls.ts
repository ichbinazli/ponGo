...
export async function verifyPassword(userId: number, password: string) {
    try {
        ...
        console.log('Password verification API response:', response);
...
export async function startTournament(payload: TournamentStartPayload) {
    try {
        ...
        console.log('Tournament start API response:', response);
        return response;
    } catch (error) {
...
export async function createTournament(name: string, maxPlayers: number) {
    try {
        ...
        console.log('Tournament creation API response:', response);
        return response;
    } catch (error) {
...
export async function tournamentAddParticipant(tournamentId: number, userId: number, alias: string) {
    try {
        ...
        console.log('Add participant API response:', response);
        return response;
    } catch (error) {
...
export async function tournamentAddGuest(tournamentId: number, alias: string) {
    try {
        ...
        console.log('Add guest API response:', response);
        return response;
    } catch (error) {
